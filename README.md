...
## :paintbrush: DEMO
:small_red_triangle:[[X-GPT](https://huggingface.co/spaces/xdecoder/Instruct-X-Decoder)] :small_red_triangle:[[Instruct X-Decoder](https://huggingface.co/spaces/xdecoder/Instruct-X-Decoder)]
